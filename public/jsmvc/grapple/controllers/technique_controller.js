 ...
 * ["Grapple.Controllers.Technique.prototype.form submit" create], 
 * ["Grapple.Controllers.Technique.prototype.&#46;edit click" edit],
 * or ["Grapple.Controllers.Technique.prototype.&#46;destroy click" destroy] techniques.
 */
$.Controller.extend('Grapple.Controllers.Technique',
/* @Static */
{
	onDocument: true
},
 ...
 load: function(){
	if(!$("#technique").length){
	 $(document.body).append($('<div/>').attr('id','technique'));
		 Grapple.Models.Technique.findAll({}, this.callback('list'));
 	}
 },
 /**
 * Displays a list of techniques and the submit form.
 * @param {Array} techniques An array of Grapple.Models.Technique objects.
 */
 list: function( techniques ){
	$('#technique').html(this.view('init', {techniques:techniques} ));
 },
 /**
 * Responds to the create form being submitted by creating a new Grapple.Models.Technique.
 * @param {jQuery} el A jQuery wrapped element.
 * @param {Event} ev A jQuery event whose default action is prevented.
 */
'form submit': function( el, ev ){
	ev.preventDefault();
	new Grapple.Models.Technique(el.formParams()).save();
},
/**
