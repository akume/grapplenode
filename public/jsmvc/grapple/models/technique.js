 ...
 * [Grapple.Models.Technique.static.findAll retrieving],
 * [Grapple.Models.Technique.static.update updating],
 * [Grapple.Models.Technique.static.destroy destroying], and
 * [Grapple.Models.Technique.static.create creating] techniques.
 */
$.Model.extend('Grapple.Models.Technique',
/* @Static */
{
	/**
	...
	findAll: function( params, success, error ){
		$.ajax({
			...
			error: error,
			fixture: "//grapple/fixtures/techniques.json.get" //calculates the fixture path from the url and type.
		});
	},
	/**
